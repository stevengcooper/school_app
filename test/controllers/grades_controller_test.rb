...
class GradesControllerTest < ActionController::TestCase
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post :create, grade: { assignment_name: @grade.assignment_name, date: @grade.date, score: @grade.score }
    end
  ...
  test "should update grade" do
    patch :update, id: @grade, grade: { assignment_name: @grade.assignment_name, date: @grade.date, score: @grade.score }
    assert_redirected_to grade_path(assigns(:grade))
  end
